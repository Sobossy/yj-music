...
__DEFINE__(1691050203963, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1691050203964,"./event-store":1691050203965}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1691050203964, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1691050203965, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1691050203964,"./utils":1691050203966}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1691050203966, function(require, module, exports) {
...
return __REQUIRE__(1691050203963);
})()
